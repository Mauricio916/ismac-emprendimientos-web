    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand active" href="${pageContext.request.contextPath}/">Emprendimientos</a>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Emprendimientos</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Bienvenidos a su pagina de Emprendimientos</p>
                </div>
            </div>
        </header>
        <!-- Section-->
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
              ...
              aqui viene información general
